...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2024 at 05:29 PM
...
CREATE TABLE `purchase_orders` (
  ...
  `received_quantity` varchar(500) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sales` (
  ...
  `sales_person_name` varchar(300) NOT NULL,
  `sales_date` date NOT NULL,
  `payment_method` enum('cash','financing','lease') NOT NULL,
  `financing_details` text DEFAULT NULL,
  `trade_in_details` text DEFAULT NULL,
  `discounts_offers` text DEFAULT NULL,
  `total_price` decimal(10,2) NOT NULL,
  `warranty_type` enum('standard','extended','none') NOT NULL,
  ...
  `signed_contract` enum('yes','no') NOT NULL,
...
INSERT INTO `sell_my_cars` (`id`, `city`, `city_area`, `car_info`, `color`, `mileage`, `price`, `add_description`, `upload_image`, `created_at`, `updated_at`) VALUES
(1, 'balochistan', 'In temporibus quis d', 'Pariatur Laborum lo', 'Odit sint sint magn', 46, 215, 'Enim id beatae sunt', 'images/wukRwxMmnwAripIgyatsRjTMPyuSMI0JWuVom6OM.jpg', '2024-09-13 13:51:00', '2024-09-13 14:14:04'),
(2, 'balochistan', 'In temporibus quis d', 'Pariatur Laborum lo', 'Odit sint sint magn', 46, 215, 'Enim id beatae sunt', 'images/RwICX13UBCgunUGiU8yCc7zLxEgsIYu0KJa5qk84.jpg', '2024-09-13 13:51:13', '2024-09-13 14:32:14'),
(3, 'balochistan', 'Dolor aute asperiore', 'Autem et aut deserun', 'Non minus doloribus', 79, 356, 'Quod quis aut dolore', 'images/lWqktUhtFyjlhNWRjLztr5hhnquiZPqFb5ezRh7a.jpg', '2024-09-13 13:52:04', '2024-09-13 14:26:38'),
(4, 'balochistan', 'Ea velit qui qui sin', 'Recusandae Dolores', 'Consequat Et nihil', 28, 838, 'Cillum excepteur imp', 'images/1726240113.jpg', '2024-09-13 14:28:52', '2024-09-13 15:08:33'),
(5, 'balochistan', 'Quaerat provident o', 'Molestiae cumque fug', 'Beatae enim ipsum vo', 49, 183, 'Qui voluptate optio', 'images/1726237950.instagram-0534_1704144381.jpg', '2024-09-13 14:32:30', '2024-09-13 14:32:30'),
(6, 'balochistan', 'Nihil facere magna d', 'Commodo omnis ipsa', 'Id itaque ea sint li', 95, 518, 'Amet esse ad ducim', 'images/1726238347.jpg', '2024-09-13 14:34:47', '2024-09-13 14:39:07'),
(7, 'balochistan', 'Voluptatem in et et', 'Est pariatur Do max', 'Saepe est sit tempor', 61, 121, 'Velit et perspiciati', 'images/default_image.jpg', '2024-09-13 15:02:56', '2024-09-13 15:02:56'),
(8, 'balochistan', 'Voluptatem in et et', 'Est pariatur Do max', 'Saepe est sit tempor', 61, 121, 'Velit et perspiciati', 'images/1726239782.jpg', '2024-09-13 15:03:02', '2024-09-13 15:03:02'),
(9, 'punjab', 'Dicta porro aliquip', 'Eu sed porro nisi re', 'Nam aut magnam quasi', 34, 991, 'Minima quasi dolore', 'images/1726239996.jpg', '2024-09-13 15:06:36', '2024-09-13 15:06:36');
...
('7Dv2pL63YOhathkTpQcCSL2Vu8rnq7lPey13SyW7', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '', 1726240207),
('gCfutsWZGomdc060eRl2DYzzaPPNvuuSIW9hR2Vh', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36 Edg/128.0.0.0', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiUmk3UVRJYVFtazNHN2kySzBhMk11UTF3c2lQOTBhZDdGbEFKb0hOTyI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODA4MSI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1726234549);
...
CREATE TABLE `trade_in_requests` (
  ...
  `preferred_dealership_location` varchar(255) NOT NULL,
  `car_photos` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`car_photos`)),
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `showroom_id` bigint(20) UNSIGNED DEFAULT 6,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Maaz Khan', 'maaz@gmail.com', NULL, '$2y$12$zMyU9RAmiCut5nlkxHeSzulwpLHhWFqsnZUSDOpqPEvrXpgDBC68e', '5x41ZrV9xoO2kPOFTjAeoxbbvr20kUqG2NaTfXN3.png', '3es1x6WX0epDDD81zx7De6KqWtKTFjKWEEhTtz45TMhQsPslX35KP3veVC7o', 5, 1, '2024-08-13 17:35:53', '2024-08-22 16:15:51'),

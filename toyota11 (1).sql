...
--
-- Host: localhost:3306
-- Generation Time: Sep 24, 2024 at 10:21 AM
...
('saad1@gmail.com|127.0.0.1', 'i:1;', 1727172492),
('saad1@gmail.com|127.0.0.1:timer', 'i:1727172492;', 1727172492),
...
CREATE TABLE `purchase_orders` (
  `id` bigint UNSIGNED NOT NULL,
  `po` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `showroom_id` bigint UNSIGNED NOT NULL,
  `order_date` date NOT NULL,
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_amount` decimal(10,2) NOT NULL,
  `received_quantity` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sales` (
  ...
  `invoice_number` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `customer_type` enum('new','returning','vip') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `additional_features` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `sales_person_name` varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sales_date` date NOT NULL,
  `payment_method` enum('cash','financing','lease') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `financing_details` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `trade_in_details` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `discounts_offers` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `total_price` decimal(10,2) NOT NULL,
  `warranty_type` enum('standard','extended','none') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `warranty_duration` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `service_plan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `scheduled_delivery_date` date DEFAULT NULL,
  `documents_required` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `signed_contract` enum('yes','no') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `regulatory_compliance` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `delivery_method` enum('pickup','delivery') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `delivery_address` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `delivery_status` enum('pending','shipped','delivered') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `sell_my_cars` (
  ...
  `upload_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `publish_ad` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seller_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seller_contact` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `secondary_contact` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `exterior_color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `sell_my_cars` (`id`, `user_id`, `city`, `city_area`, `car_info`, `color`, `mileage`, `price`, `add_description`, `upload_image`, `model_yaer`, `model_company`, `company_name`, `Registered_user`, `publish_ad`, `seller_name`, `seller_contact`, `secondary_contact`, `exterior_color`, `created_at`, `updated_at`) VALUES
(2, 1, 'Karachi', 'Drigh Road', 'Doloribus non ad ips', 'Molestias voluptas v', 66, 417, 'Ut facere unde dolor', 'images/1727171461.jpg', '2014', 'Civic', 'Honda', 'Registered', NULL, NULL, NULL, NULL, NULL, '2024-09-24 21:51:01', '2024-09-24 21:51:01'),
(4, 1, 'Karachi', 'Drigh Road', 'Quasi nisi doloribus', 'Nesciunt quas et es', 52, 587, 'Aut veritatis volupt', 'images/default_image.jpg', '2013', 'Civic', 'Honda', 'Registered', NULL, NULL, NULL, NULL, NULL, '2024-09-24 21:57:49', '2024-09-24 21:57:49'),
(5, 1, 'Karachi', 'Shah Faisal', 'Qui minima velit vol', 'Nihil adipisicing do', 95, 980, 'Incididunt rerum rer', 'images/default_image.jpg', '2014', 'Corolla', 'Suzuki', 'Registered', NULL, NULL, NULL, NULL, NULL, '2024-09-24 22:03:37', '2024-09-24 22:03:37'),
(6, 18, 'Lahore', 'Shahdman', 'Aperiam sit sunt pro', 'In illum nisi aute', 20, 501, 'Tenetur voluptas aut', 'images/1727172878.jpg', '2011', 'Corolla', 'Honda', 'Registered', NULL, NULL, NULL, NULL, NULL, '2024-09-24 22:14:38', '2024-09-24 22:14:38');
...
CREATE TABLE `services` (
  ...
  `service_type` enum('Routine maintenance','Repair','Specific request') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('Pending','Completed','Upcoming') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `additional_requests` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
('PXi5ZNFQ40vY2NaZh4uBpLvxSR2d48z7zUhjiQIJ', 18, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '', 1727172879);
...
CREATE TABLE `showrooms` (
  `id` bigint UNSIGNED NOT NULL,
  `shr_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shr_location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shr_contact_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `shr_contact_email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(9, 'saad', 'saad', '805', 'pudehaj@mailinator.com', '2024-09-24 22:06:02', '2024-09-24 22:06:02'),
(10, 'saad1', 'Elit qui delectus', '156', 'saad1@gmail.com', '2024-09-24 22:06:50', '2024-09-24 22:06:50');
...
CREATE TABLE `trade_in_requests` (
  ...
  `mileage` int NOT NULL,
  `vin` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `condition` enum('Excellent','Good','Fair','Poor') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `current_market_value` decimal(10,2) DEFAULT NULL,
  `additional_comments` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `preferred_contact_method` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `trade_in_timing` date NOT NULL,
  `preferred_dealership_location` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Saad Malik', 'saadmalik@gmail.com', NULL, '$2y$12$lJWS3CpoNtGcaD..2GBaPeDeVzzogCKeBIGRdXoxw0PfMaZFf/8ay', '5x41ZrV9xoO2kPOFTjAeoxbbvr20kUqG2NaTfXN3.png', '8DpTZv29NaHpbjXMEO3hKmjqQ0JndiURMaLQ08XmHiq8FpMfeJZLXZ1TAvf3', 5, 1, '2024-08-13 17:35:53', '2024-09-18 00:53:08'),
(16, 'dealer', 'dealer@gmail.com', NULL, '$2y$12$lJWS3CpoNtGcaD..2GBaPeDeVzzogCKeBIGRdXoxw0PfMaZFf/8ay', '5x41ZrV9xoO2kPOFTjAeoxbbvr20kUqG2NaTfXN3.png', NULL, 1, 4, '2024-08-20 22:56:42', '2024-09-11 14:51:40'),
(18, 'Company', 'company@gmail.com', NULL, '$2y$12$lJWS3CpoNtGcaD..2GBaPeDeVzzogCKeBIGRdXoxw0PfMaZFf/8ay', '5x41ZrV9xoO2kPOFTjAeoxbbvr20kUqG2NaTfXN3.png', 'S6Dxv8a20ORCivqsap5a97TNKWYyxSHvjKE38DkTiCaFiPGfvRgJp2EFbVLh', 5, 1, '2024-09-05 03:12:30', '2024-09-11 17:09:08'),
...
(88, 18, 'Created Dealer Name: saad Contact Number : 805', NULL, '2024-09-24 22:06:02'),
(89, 18, 'Created Dealer Name: saad1 Contact Number : 156', NULL, '2024-09-24 22:06:50');
...
CREATE TABLE `vehicles` (
  ...
  `color` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `engine_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mileage` int NOT NULL,
...
CREATE TABLE `vehicle_models` (
  ...
  `transmission_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `body_style` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `engine_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `engine_capacity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
